...
public class MD5FileUtil {
    ...
    public synchronized static String getFileMD5String(File file) throws IOException {
         ...
         */
        int fileLength =1*1024*1024*1024;
    ...
    public static void main(String[] args) throws IOException {
        ...
        File big = new File("D:/lwhSpaces/TemplateRepo/windows2008.xva");
        //File big = new File("D:/lwhSpaces/TemplateRepo/testova.xva");
